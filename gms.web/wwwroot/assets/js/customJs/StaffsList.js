...
var StaffsList = function () {
    ...
    var handleTableFilter = function () {
        ...
        const filterForm = document.querySelector('[staffs-list-filter="form"]');
        const filterButton = filterForm.querySelector('[staffs-list-table-filter="filter"]');
        const resetButton = filterForm.querySelector('[staffs-list-table-reset="reset"]');
        const selectOption = filterForm.querySelector('[staffs-list-filter="status"]');
        const creationDateRangeFilter = filterForm.querySelector('[staffs-list-date-range-filter="filter"]');
    ...
    var initFlatpickr = () => {
        const filterForm = document.querySelector('[staffs-list-filter="form"]');
        const creationDateRangeFilter = filterForm.querySelectorAll('[staffs-list-date-range-filter="filter"]');

        creationDateFlatpickr = creationDateRangeFilter[0].flatpickr({
